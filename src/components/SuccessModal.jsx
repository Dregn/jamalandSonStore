    ...
    <>
      <div className="fixed inset-0 flex items-center justify-center">
        <button
          type="button"
          onClick={openModal}
          className={`rounded-md dark:bg-gray-800 dark:text-white bg-white text-gray-800 px-4 py-2 text-sm font-medium hover:bg-gray-300 focus:outline-none focus-visible:ring-2 focus-visible:ring-white/75`}
        >
          Open dialog
        </button>
      </div>
